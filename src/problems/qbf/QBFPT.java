...
//		for (int i = 0; i < qbf.triples.length; i++) {
//			for (int j = 0; j < qbf.triples[i].length; j++) {
//				System.out.print(qbf.triples[i][j] + ", ");
//			}
//			System.out.println();
//		}		
//		qbf.printMatrix();
...
//			System.out.println("f(x) = " + eval);
		...
		System.out.println("x = " + Arrays.toString(qbf.variables));
		System.out.println("f(x) = " + qbf.evaluateQBFPT());
